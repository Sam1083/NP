        ...
        <div className="col-lg-6">
          <div className="bg mt-10" style={{ padding: "130px" }}>
            <div className="d-flex flex-column">
              ...
              >
                <h1
                  className="text-black text1"
                  style={{ marginBottom: "-14px" }}
                >
                  Creative Solutions
                </h1>
                <h1
                  className="text-black text2"
            ...
            >
              ...
              <button
                className="text-dark flex border ml-8 mt-8 rounded-full p-1 touch-btn"
                style={{
                  marginRight: "-250px",
                  marginTop: "20px",
              ...
              >
                ...
                />
                <p
                  className="flex justify-center get"
                  style={{
                    // fontSize: "14px",
                    // marginLeft: "8px",
                    color: "white",
